...
import { X, CheckCircle2, MessageCircle, PhoneCall, ShieldCheck, Wrench, Tag, Check, Sparkles, Award, Cpu, FileText, CheckSquare } from 'lucide-react';
  ...
  return (
    <Drawer.Root open={true} onOpenChange={(open) => !open && onClose()} shouldScaleBackground>
      <Drawer.Portal>
        ...
        <Drawer.Content 
          ref={modalRef}
          className="fixed bottom-0 left-0 right-0 bg-white flex flex-col rounded-t-[20px] h-[92vh] z-[10000]"
          style={{ zIndex: 10000 }}
        >
          <div className="mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-gray-300 mt-4 mb-2" />
          
          <div className="overflow-auto p-4 md:p-8" style={{ width: '100%', height: '100%' }}>
            ...
            <div className="modal-grid-container" style={{ marginTop: '0', padding: '0', boxShadow: 'none', background: 'transparent' }}>
